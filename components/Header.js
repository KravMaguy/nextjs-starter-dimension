...
const People = {
  ...
  p:
    "Hire us to build your web applications, devise your internet marketing plan, Manage your digital advertising, and craft custom buisness solutions using cutting edge technologies.",
};
const Abe = {
  header: "Abe",
...
const Header = (props) => (
  <header id="header" style={props.timeout ? { display: "none" } : {}}>
    <div
      id=""
      onClick={() => props.isDrawing()}
      className="logo glowButton"
      tabIndex={0}
      onKeyPress={(handleKeyPress, props.isDrawing)}
    >
      ...
      <div>
        ...
        <FaCode
          id="codeButton"
          style={props.draw ? { transform: "rotateX(3.142rad)" } : {}}
        />
      </div>
    </div>
    <div className="content">
      <div className="inner">
        ...
        <h2>
          {!props.draw && !props.isArticleVisible
            ? People["header"]
            : Abe["header"]}
        </h2>
